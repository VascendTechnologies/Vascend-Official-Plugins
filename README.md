...
Da marketplace/repo locale:

```
/plugin marketplace add LorenzoDanilov/danilov-method
/plugin install danilov-method
```

Oppure clonando il repo in un marketplace locale e installandolo da lì.
